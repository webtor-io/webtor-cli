...
screens are arrow-key lists — ↑↓/jk move, the mouse works too (the row under
the pointer underlines like a link, click selects, wheel scrolls), typing filters live, Enter selects, Tab marks
